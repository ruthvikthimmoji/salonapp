    ...
    <div className='bg-red-300 w-screen max-h-screen '>
      ...
      <div className='border border-Neutral-50 p-10 rounded-md bg-red-300 '>
        <div>
          ...
          <label className='block mb-4 font-bold' htmlFor="otp">Enter OTP </label>
          <input className="block w-full px-4 py-2 mb-4 border rounded-md bg-transparent text-black"  type='text' id='otp' name='otp' maxLength={4} pattern='[0-9]{4}' autoComplete='one-time-code' placeholder='OTP' />
